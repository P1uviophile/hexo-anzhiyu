---
title: Vercel部署Meting-API并添加网易云cookie
...
cover: https://pic.joking7.com/2024-06-22-00-37-42.webp

date: 2024-06-21 15:44:00
---
## 前言

前排提醒:**绑定cookie可能会有未知风险**
...
![2024-06-27-19-17-42](https://pic.joking7.com/2024-06-27-19-17-42.webp)
...
[Vercel部署Meting](https://vercel.com/new/clone?s=https%3A%2F%2Fgithub.com%2Fxizeyoupan%2FMeting-API&showOptionalTeamCreation=false)

填好名字后点击Create创建项目:

![2024-06-27-18-08-31](https://pic.joking7.com/2024-06-27-18-08-31.webp)

之后点击Add Domain查看接口url,注意Vercel在国内被墙了,想要在国内访问的话需要绑定自己的域名:

![2024-06-27-18-13-41](https://pic.joking7.com/2024-06-27-18-13-41.webp)

到此Vercel部署MetingAPI已成功

## 2 获取网易云音乐账号cookie

注意:**cookie就是你的账号,所以不要泄露出去**

登录网易云网页版并随便点进一首歌,按F12后找到下面的Cookie:

![2024-06-27-19-00-17](https://pic.joking7.com/2024-06-27-19-00-17.webp)

将cookie字段的字符串全部复制备用(这里我不知道哪些是要用到的字段所以就全部复制了,如果你知道可以只复制指定的字段)

## 3 添加网易云cookie

之前Vercel部署MetingAPI的时候自动往你的Github下创建了一个同名项目,找到上面创建的Github项目下的src/providers/netease/util.js文件

![2024-06-27-18-28-39](https://pic.joking7.com/2024-06-27-18-28-39.webp)
...
将之前得到的网易云cookie替换到上面代码中的customCookieString,提交,访问之前Vercel项目url,查看是否可以访问歌曲,可以就成功了

## 4 Hexo Butterfly主题使用自建API

配置前确保安装并启用了APlayer插件

修改_config.butterfly.yml配置文件,填入你的Vercel项目api:
...
CDN:
  option:
    meting_api: 'https://（你的Vercel项目api地址）/api/?server=:server&type=:type&id=:id&auth=:auth&r=:r';

```

当然你要是也用anzhiyu主题的话使用方法也和上面一样

## 5 效果展示

![2024-06-27-19-17-12](https://pic.joking7.com/2024-06-27-19-17-12.webp)

[展示链接](/music/?id=8480620009&server=netease)

## 参考博客

[自建Meting服务 | 星空故事·魔法小屋 (sinzmise.top)](https://blog.sinzmise.top/posts/61417/)

[部署Meting-API | 定の栈 (saop.cc)](https://blog.saop.cc/p/300/#%E5%BA%94%E7%94%A8%E4%BA%8E-hexo-%E7%9A%84-butterfly-%E4%B8%BB%E9%A2%98)

[♪(^∇^*)欢迎肥来！音乐meting自建api | 安知鱼 (anheyu.com)](https://blog.anheyu.com/posts/a76e.html)
